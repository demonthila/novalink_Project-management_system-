  ...
  return (
    <div className="min-h-screen bg-[#F0F7FF] flex items-center justify-center p-6 font-sans">
      ...
      <div className="w-full max-w-lg bg-white rounded-[40px] shadow-2xl p-12 space-y-10 relative border border-white/40">
        ...
        <form onSubmit={(e) => { e.preventDefault(); onLogin(pass); }} className="space-y-8">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input 
                    defaultValue="admin"
                    disabled
                    className="w-full px-6 py-4 bg-slate-50 border border-slate-200 rounded-2xl text-slate-400 font-bold cursor-not-allowed transition-all"
                />
              </div>
            </div>
            <div className="space-y-2">
        ...
        <div className="text-center pt-8 border-t border-slate-100">
          <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">
            ...
            <br/> 
            <span className="text-[#0A69E1] mt-2 block opacity-60">Demo: admin123</span>
          </p>
        </div>
      </div>
    </div>
