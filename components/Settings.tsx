...
const Settings: React.FC<SettingsProps> = ({ users, currentUsername, currentUserRole, usersLoading, adminOnlyMessage, onAddUser, onDeleteUser, onEditUser }) => {
    ...
    const isPrimarySuperadmin = currentUsername === 'sanjulathilan12321@gmail.com';
            ...
            {isPrimarySuperadmin && (
                <section className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                    <div className="px-5 py-3.5 border-b border-slate-100 bg-slate-50/50 flex flex-wrap items-center justify-between gap-4">
                        <div>
                            <h3 className="text-xs font-bold text-slate-600 uppercase tracking-wider">User Access Management</h3>
                                        ...
                                        <tr key={user.id} className="hover:bg-slate-50/50 transition-colors">
                                            ...
                                            <td className="px-5 py-3 text-right">
                                                <div className="flex items-center justify-end gap-1">
                                                    ...
                                                    {user.username !== currentUsername && user.username !== 'sanjulathilan12321@gmail.com' && (
                                                        <button
                                                            type="button"
